<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"
        ...
        $review = $_POST['review'];
        $sql = "UPDATE task SET 
            score = '$score', review ='$review' WHERE id = '$idTask';";
        mysqli_query($db, $sql);
        mysqli_close($db);
...
<div class="container">
        ...
        <form  action = "<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="range" class="form-control-range" id="score" name="score" min="0" max="10">
            </div>
            <div class="form-group">
                <label for="exampleFormControlTextarea1">Comentarios</label>
                <textarea class="form-control" id="review" name="review" rows="3"></textarea>
            </div>
            <button type="submit" class="btn btn-primary col-12">Calificar</button>
        </form>
        <br>
        <div>
